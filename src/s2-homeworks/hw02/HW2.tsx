...
export const filterAffairs = (affairs: AffairType[], filter: FilterType): AffairType[] => { // need to fix any
    ...
    if(filter === 'low'){
        filteredAffairs = affairs.filter(affair => affair.priority === 'low')
    }
    if(filter === 'middle'){
        filteredAffairs = affairs.filter(affair => affair.priority === 'middle')
    }
    if(filter === 'high'){
        filteredAffairs = affairs.filter(affair => affair.priority === 'high')
    }
